...
const Navbar4: React.FC<ContentProps> = ({ logo, category, link, color, background, handleOnClick, cartLength }) => {

  return (
    <div className="navbar-ctn-4" style={{ background: background }}>
      <div className="logo">
        {logo ?
